    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Dicuciin.co</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="data_user.php">User</a>
                        <a class="collapse-item" href="data_member.php">Member</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tambah_transaksi.php">Transaksi</a>
                        <a class="collapse-item" href="tambah_member.php">Transaksi NonMember</a>
                        <a class="collapse-item" href="data_transaksi.php">Histori Transaksi</a>
            ...
            <!-- Nav Item - Outlet -->
            <li class="nav-item">
                <a class="nav-link" href="data_outlet.php">
       ...
       <tbody>
        ...
        while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
          ...
          <tr>
            ...
            <td><?= $data_paket_kembali['jenis_paket'] ?></td>
            ...
            if ($data_transaksi['status'] == "baru") {
                ?> <a href="ubah_proses.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?> " style="text-decoration: none; color: #000080">proses |</a>
                <a href="ubah_selesai.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" style="text-decoration: none; color: #000080">selesai |</a>
                <a href="ubah_diambil.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" style="text-decoration: none; color: #000080">diambil</a>
...
<a href="hapus_transaksi.php" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-secondary"> Hapus History </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; fathzyya_ 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
