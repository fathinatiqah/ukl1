...
if($_POST){
    ...
    if(empty($nama)){
        ...
        echo "<script>alert('nama member tidak boleh kosong');location.href='data_member.php';</script>";
        ...
        echo "<script>alert('telepon tidak boleh kosong');location.href='data_member.php';</script>";
        ...
        if($update){
            ...
            echo "<script>alert('Sukses update member');location.href='data_member.php';</script>";
    
        } else {
    
            echo "<script>alert('Gagal update member');location.href='ubah_member.php';</script>";
        }
    }
}
?>