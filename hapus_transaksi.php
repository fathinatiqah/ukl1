<?php
    ...
    if($qry_hapus and $qry_hapus_transaksi and $AI_transaksi and $AI_detail_transaksi){
        echo "<script>alert('Sukses hapus history transaksi');location.href='data_transaksi.php';</script>";
    } else {
        echo "<script>alert('Gagal hapus history transaksi');location.href='data_transaksi.php';</script>";
    }
?>